...
const CripToe = CripToe$1;
const calcAge = (anniversary) => Math.round(Math.abs(new Date(anniversary).getTime() - new Date().getTime()) /
    8.64e7 /
    365);
const ranNumG = (max) => Math.floor(Math.random() * max);
const makeArray = (maxIndex, useKeysBool) => {
    if (useKeysBool) {
...
exports.CripToe = CripToe;
exports.calcAge = calcAge;
exports.default = Utils;
exports.getLanguage = getLanguage;
exports.isBase64 = isBase64;
exports.makeArray = makeArray;
exports.normalizeEpochDate = normalizeEpochDate;
exports.ranNumG = ranNumG;
